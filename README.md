...
| `--voice` | `cixingnansheng` | A StepFun voice ID (not an OpenAI name). See `list-voices`. |
...
Tests cover the chunking engine and cleaner (the deterministic, network-free
core) and do not require an API key.
